...
- Firestore (users/progress/surveyResponses)
- Vercel deployment
...
## 4) Firestore schema đề xuất
- `users/{uid}`: displayName, email, createdAt, totalPoints
...
- `src/lib/firestore.ts`: bootstrap user + cập nhật điểm
